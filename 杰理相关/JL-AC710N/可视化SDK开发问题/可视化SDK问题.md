...
- Siri的提示音跟通话音量是一起的，意味着只能调通话音量了。。。

### 固定通话音量位置

- 相当于进通话时修改音量
  - 开麦时，Siri唤出也是开麦。
- 后续看看能不能隔离开单独设置Siri和接听通话的音量
...
int bt_phone_active(u8 *bt_addr)
{
    ...
    bt_tws_sync_volume();
#else
    g_bt_hdl.phone_vol = _SET_DEFAULT_PHONE_VOL_SCALE;//这个比例不对，需要验证
    bt_tws_sync_volume();
#endif
...
ANC的麦脚位配置时，有复用的脚位时，首先避开DP,DM.写另一个配置。有复用脚位时，如果能进入ANC在线工具，但是没有效果，就要看看麦的脚位
...
- 关机会直接开机的。
- 关闭就不会自动开机，但是触摸模块依旧灵敏，一直输出打印唤醒日志，只不过没有达到唤醒条件而已
- 触摸唤醒与上电开机是互斥的，从可视化工具中就可以看出。
...
![image-20260206105323713](./可视化SDK问题.assets/image-20260206105323713.png)

## 生成反汇编文件

![img](./可视化SDK问题.assets/BMAKEPIXADQHO.png)
...
CPU0 Trace: 0x001080FE -->0x00108120 -->0x000FEB9E -->0x000FEBC6 
...
70 0F 40 00 0C BB 13 00 C6 74 10 00 40 00 00 00 
88 29 10 00 E4 D0 E3 0F 70 0F 40 00 00 00 00 00 
02 00 00 00 BA 10 E4 0F 28 E4 0F 00 00 00 00 00 
50 88 41 00 80 88 41 00 58 88 41 00 A4 E4 0F 00 
70 0F 40 00 F0 1E 10 00 74 0F 40 00 34 14 E6 0F 
09 00 00 00 34 14 E6 0F A0 D0 E7 0F B0 50 E7 0F 
30 ED E0 0F 00 00 00 00 F0 1E 10 00 74 0F 40 00 
34 14 E6 0F 09 00 00 00 0D 00 10 00 F2 D6 E1 0F 
13 00 00 00 75 0F 40 00 89 00 30 00 B2 10 E4 0F 
01 01 00 00 00 00 00 00 54 28 10 00 18 33 10 00 
6B C8 E8 0F 18 33 10 00 D0 45 10 00 DD B4 9A 90 
54 55 E0 0F F8 32 10 00 18 33 10 00 6C EE E0 0F 
0D 00 00 00 00 00 00 00 0E 1A F5 AD 67 B2 10 01 
09 00 00 00 02 00 00 00 00 00 00 00 0A 00 00 00 
EF 89 E8 0F F8 32 10 00 D0 45 10 00 DD B4 9A 90 
C6 23 D4 F9 D9 34 90 F7 0E 29 4E 29 A2 73 7E 48 
13 25 24 6E 39 9F 7B 0F 42 62 E2 34 70 AD 1F 19 
0C EE E0 0F 9D 4E 35 20 00 00 00 00 00 00 00 00 
...
C6 EB 0F 00 0C 36 E1 0F 00 00 00 00 9E EB 0F 00 
...
0x00000034 0x025D501F 0x025D5F7C 0x00001F35 0x025D5F7C lp_touch_key
4A 81 10 00 DE D9 0F 00 06 00 00 00 00 00 00 00 
...
FF FF FF FF 01 00 00 00 32 00 00 00 E8 E4 0F 00 
01 12 00 00 32 00 00 00 00 00 00 00 04 00 00 00 
01 00 00 00 5C 49 10 00 FF FF 00 00 FE FF FF FF 
2E 02 E5 0F 98 72 E7 0F A8 60 0C 92 92 E1 5E D0 
01 00 10 00 08 00 00 00 00 00 00 00 00 00 00 00 
95 4D 46 BA 8D 22 3A 9F 33 8A 67 D1 7C 7E 8D 83 
F4 BE F5 5C C5 6A 77 F5 0F 81 C0 CC 43 B4 15 C1 
C6 C6 07 D4 A7 0B 39 C4 67 83 15 C3 BD 3A 4A DE 
65 48 01 12 0A 12 F6 11 01 00 00 00 60 19 B9 AA 
...
A1 80 EA 9A 01 00 00 00 E0 91 E7 0F E8 E4 0F 00 
BC 2F 40 00 B0 10 E7 0F 81 B0 17 EA 44 26 10 00 
81 B8 96 70 4B 5D E7 0F 00 00 00 00 92 A1 E9 29 
94 F9 E1 0F 00 00 00 00 A2 D7 DC 67 3C 25 15 93 
00 81 60 E6 09 00 D5 B2 E9 E2 A3 3A 81 B0 17 EA 
2E 6B 31 90 81 B8 96 70 13 A9 F9 18 6A CA 7E 63 
92 A1 E9 29 EB 18 A0 65 A1 80 EA 9A C9 80 6A DC 
CA A6 1A D8 C0 A1 F7 01 

anc task backtrace : 
StackPush / SwInTime / SwOutTime / RunTime / LastRunTime / Name
0x0000002E 0x0263AA1B 0x0263AB27 0x0000022B 0x0263AB27 led_driver
4A 81 10 00 DE D9 0F 00 06 00 00 00 00 00 00 00 
00 00 00 00 A0 E1 FF 00 58 93 41 00 00 00 00 00 
14 8D 41 00 44 8D 41 00 1C 8D 41 00 BC 27 40 00 
0C BB 13 00 10 00 00 00 00 00 00 00 B8 C9 B2 BA 
4A 64 73 C9 AA 07 E2 95 DA 66 1A FA E8 E4 0F 00 
A5 12 E7 0F BC 27 40 00 01 00 10 00 68 F1 67 10 
32 BE DF 4B D4 20 3E CE 5A 2F 3D F1 9A 00 15 68 
D4 21 E0 0F 01 00 10 00 74 37 10 00 05 00 00 00 
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 
00 00 00 00 60 4F 2B FA 

led_driver task backtrace : 
StackPush / SwInTime / SwOutTime / RunTime / LastRunTime / Name
0x0000002E 0x01DAE16A 0x01DC9F5D 0x00000000 0x01DC9F5D jlstream
4A 81 10 00 DE D9 0F 00 06 00 00 00 00 00 00 00 
00 00 00 00 A0 E1 FF 00 00 00 00 00 00 00 00 00 
04 8B 41 00 34 8B 41 00 0C 8B 41 00 DC 23 40 00 
0C BB 13 00 08 00 00 00 00 00 00 00 5B 01 01 71 
4B 5E 0E 5D EA BE D4 34 10 2C 43 95 E8 E4 0F 00 
00 00 00 00 48 59 10 00 BC 23 40 00 6C D8 41 00 
E0 23 40 00 48 59 10 00 BE 23 40 00 AE 46 83 16 
84 E9 E0 0F 00 00 00 00 00 00 8A FF 00 00 00 00 
00 00 00 00 00 00 00 00 F3 F3 A3 01 5C D8 41 00 
00 00 00 00 7B 00 30 00 9E BA E2 0F 01 01 00 00 
00 00 00 00 A0 27 10 00 4B 5E 0E 5D EA BE D4 34 
10 2C 43 95 D3 C8 A9 00 

jlstream task backtrace : 
StackPush / SwInTime / SwOutTime / RunTime / LastRunTime / Name
0x00000016 0x0267F932 0x02695D11 0x001CAD53 0x02695D11 IDLE0
4A 81 10 00 DA 7F 10 00 06 00 00 00 00 00 00 00 
00 00 00 00 01 01 00 00 00 01 00 00 A8 B2 9D 09 
AF 18 9F 88 AF C9 36 97 0F 00 1E 59 9A CE 12 8E 
51 F2 D6 F6 E8 55 49 43 A5 14 1E 18 19 0E 4C CD 
2A CC 73 9C B9 12 25 EC 90 75 A2 42 B9 12 25 01 
C8 79 10 00 81 7C B7 BA 

IDLE0 task backtrace : 
StackPush / SwInTime / SwOutTime / RunTime / LastRunTime / Name
0x0000004A 0x02695D11 0x0267F932 0x00015741 0x0267F932 app_core
40 00 00 00 88 29 10 00 00 00 00 00 01 00 00 00 
70 0F 40 00 0C BB 13 00 C6 74 10 00 40 00 00 00 
88 29 10 00 E4 D0 E3 0F 70 0F 40 00 00 00 00 00 
02 00 00 00 BA 10 E4 0F 28 E4 0F 00 00 00 00 00 
...
0x000FEBC6 (中断/异常入口)
    ↓ 调用
0x000FEB9E (可能是异常处理函数)
    ↓ 调用
0x00108120 
    ↓ 调用
0x001080FE (崩溃点！MMU异常发生在这里)
```

### 在 sdk.lst 中查找这些地址

打开 `sdk.lst` 文件，搜索以下地址（去掉前面的0）：
...
void app_send_message(int _msg, int arg)
{
    ...
    printf("app_send_message :0x%x", rets_addr);
